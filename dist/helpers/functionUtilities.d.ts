...
export declare function getRenderFunction(jsx: string, parseExpression: (body: string, exp: AcornJSX.Expression, scope?: Record<string, any>, baseOffset?: number) => any, sourceBaseOffset?: number): (args: Record<string, any>) => any;
export declare function getAllJsxElements(code: string): (AcornJSX.JSXElement | AcornJSX.JSXFragment)[];
export declare function transpileFunctionBody(body: string, parseExpression: (jsx: string, exp: AcornJSX.Expression, scope?: Record<string, any>, sourceBaseOffset?: number) => any, mapBodyOffsetToSource?: (bodyOffset: number) => number): [string, Record<string, any>];
